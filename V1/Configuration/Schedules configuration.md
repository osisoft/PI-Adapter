...
**Note:** If the adapter supports scheduling and an ingress component is started without a configured schedule configuration, a default one will be added to the schedules configuration to be used as an example.
