...
| api/v1/configuration/system/healthEndpoints     | PATCH     | Allows partial updating of configured health endpoints within an array. **Note:** To identify the health endpoints to be updated, Id must be included in the array. |
