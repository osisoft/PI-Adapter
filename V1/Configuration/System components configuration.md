...
The full schema definition for the system components configuration is in the *System_Components_schema.json* file located in one of the folders listed below:
