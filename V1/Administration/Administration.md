...
With the OSIsoft adapter administration level functions, you can start and stop an adapter and the ingress component. You can also retrieve product version information and delete an adapter.
